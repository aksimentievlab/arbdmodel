# Description: This script is used to run the BD simulations for the shape-based CG model. It is based on the script from the shape_cg.py file
from pathlib import Path
import dill

import numpy as np
from arbdmodel.coords import rotationAboutAxis, quaternion_to_matrix, quaternion_from_matrix, quaternion_slerp, readArbdCoords
from arbdmodel import Group, ArbdModel
