...
def validate_atom(atom):
    """dict_keys(['list', '_idx', 'atomic_number', 'name', 'type', '_charge', 'mass', 'nb_idx', 'solvent_radius', 'screen', 
    'tree', 'join', 'irotat', 'bfactor', 'altloc', 'occupancy', '_bond_partners', '_angle_partners', '_dihedral_partners', 
    '_tortor_partners', '_exclusion_partners', 'residue', 'marked', 'bonds', 'angles', 'dihedrals', 'urey_bradleys', 'impropers', 
    'cmaps', 'tortors', 'other_locations', 'atom_type', 'number', 'anisou', '_rmin', '_epsilon', '_rmin14', '_epsilon14', 'children',
     'aromatic', 'formal_charge', 'hybridization', 'props', 'xx', 'xy', 'xz']) """
