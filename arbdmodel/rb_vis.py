...
class ArbdVis:
    ...
    psf_path: Psf file path for particles generated by arbdmodel. 
    ...
    def __init__(
        ...
        self.psf_path   = Path(psf_path) if psf_path else get_resource_path("dummy.psf")
    ...
    def _write_launcher_tcl(self) -> Path:
        ...
        lines = [
            ...
            f"set attachID [mol new {{{self.psf_path}}}]",
            "mol off $attachID",
            "",
        ]
